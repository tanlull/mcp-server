...
def test_connection_verbose():
    ...
    print("\n🔍 Testing database connection with pymssql...")
    ...
    try:
        ...
        conn = pymssql.connect(
            ...
            timeout=10  # Increase timeout for slow connections
        )
        ...
        if tables:
            ...
            try:
                df = pd.read_sql(f"SELECT TOP 5 * FROM [{test_table}]", conn)
...
if __name__ == "__main__":
    print("=" * 60)
    print("MSSQL Connection Debugging Tool")
    print("=" * 60)
